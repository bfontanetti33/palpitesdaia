...
export const matches: Match[] = [
  {
    ...
    date: at(21, 30),
    status: "scheduled",
    home: { name: "Flamengo", short: "FLA", logo: logo("FLA", "#dc1f2c") },
    away: { name: "Palmeiras", short: "PAL", logo: logo("PAL", "#0a5f3c") },
  ...
  },
  {
    ...
    date: at(17, 0),
    status: "scheduled",
    home: { name: "Real Madrid", short: "RMA", logo: logo("RM", "#febd17") },
    away: { name: "Barcelona", short: "BAR", logo: logo("BAR", "#a50044") },
  ...
  },
  {
    ...
    date: at(13, 30),
    status: "scheduled",
    home: { name: "Manchester City", short: "MCI", logo: logo("MCI", "#6cabdd") },
    away: { name: "Arsenal", short: "ARS", logo: logo("ARS", "#ef0107") },
  ...
  },
  {
    ...
    date: at(19, 0),
    status: "scheduled",
    home: { name: "Bahia", short: "BAH", logo: logo("BAH", "#005ca9") },
    away: { name: "Fortaleza", short: "FOR", logo: logo("FOR", "#003c8f") },
  ...
  },
  {
    ...
    date: at(16, 0, 1),
    status: "scheduled",
    home: { name: "PSG", short: "PSG", logo: logo("PSG", "#004170") },
    away: { name: "Marseille", short: "OM", logo: logo("OM", "#2faee0") },
  ...
  },
  {
    ...
    date: at(22, 0, 1),
    status: "scheduled",
    home: { name: "Boca Juniors", short: "BOC", logo: logo("BOC", "#0a3a8a") },
    away: { name: "River Plate", short: "RIV", logo: logo("RIV", "#cc1133") },
